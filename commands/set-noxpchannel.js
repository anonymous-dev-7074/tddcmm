...
exports.run = (client, msg, args) => {
  ...
  if (array.includes(channel.id)) {
    ...
    msg.channel.send(
      "You already had that channel disabled to get xp in, I removed it from the list. You will now get xp again."
    );
    return;
  }

  client.settings.push(msg.guild.id, msg.channel.id, "noxpchannels");
